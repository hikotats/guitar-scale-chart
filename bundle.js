...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _selecter = __webpack_require__(199);
	...
	var store = (0, _redux.createStore)(_selecter2.default);
...
/***/ (function(module, exports) {
	...
	exports.default = function () {
	  ...
	  switch (action.type) {
	    case 'SELECT_KEY':
	      {
	        return _extends({}, state, { tonality: action.payload });
	      }
	    case 'SELECT_MODE':
	      {
	...
	var selectKey = exports.selectKey = function selectKey(tonality) {
	  return {
	    type: SELECT_KEY,
	    payload: tonality
	  };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _scaleChart = __webpack_require__(201);

	var _scaleChart2 = _interopRequireDefault(_scaleChart);
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    selectKey: function selectKey(k) {
	      dispatch((0, _selecter.selectKey)(k));
	    },
	    selectMode: function selectMode(m) {
	      dispatch((0, _selecter.selectMode)(m));
	    }
	  };
	};

	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_scaleChart2.default);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _canvasBack = __webpack_require__(202);

	var _canvasBack2 = _interopRequireDefault(_canvasBack);

	var _canvasFront = __webpack_require__(209);

	var _canvasFront2 = _interopRequireDefault(_canvasFront);

	var _selectKey = __webpack_require__(210);

	var _selectKey2 = _interopRequireDefault(_selectKey);

	var _selectMode = __webpack_require__(219);
	...
	var ScaleChart = function (_Component) {
	  _inherits(ScaleChart, _Component);

	  function ScaleChart() {
	    _classCallCheck(this, ScaleChart);

	    return _possibleConstructorReturn(this, (ScaleChart.__proto__ || Object.getPrototypeOf(ScaleChart)).apply(this, arguments));
	  }

	  _createClass(ScaleChart, [{
	    key: 'handleSelectKey',
	    value: function handleSelectKey(k) {
	      this.props.selectKey(k);
	    }
	  }, {
	    key: 'handleSelectMode',
	    value: function handleSelectMode(mode) {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          'key: ',
	          _react2.default.createElement(_selectKey2.default, { className: 'select-key', onChange: function onChange(e) {
	              return _this2.handleSelectKey(e.target.value);
	            } }),
	          'scale: ',
	          _react2.default.createElement(_selectMode2.default, { className: 'select-mode', onChange: function onChange(e) {
	              return _this2.handleSelectMode(e.target.value);
	            } })
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'wrapper' },
	          _react2.default.createElement(_canvasBack2.default, this.props),
	          _react2.default.createElement(_canvasFront2.default, _extends({}, this.props, { className: 'fingerPosition' }))
	        )
	      );
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Mode = _.Const.Mode,
	    Key = _.Const.Key,
	    Size = _.Const.Size,
	    Style = _.Const.Style;

	var CanvasBack = function (_Component) {
	  _inherits(CanvasBack, _Component);

	  function CanvasBack(props) {
	    _classCallCheck(this, CanvasBack);

	    return _possibleConstructorReturn(this, (CanvasBack.__proto__ || Object.getPrototypeOf(CanvasBack)).call(this, props));
	  }
	  ...
	  _createClass(CanvasBack, [{
	    ...
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement('canvas', { className: 'fingerBoard', ref: 'canvas', width: '1024px', height: '256px' });
	    }
	  }]);
	...
	exports.default = CanvasBack;


	function drawFlet(ctx, scale) {
	  var startX = Size.RIGHT_OFFSET;
	  var startY = Size.TOP_OFFSET;
	  var endX = Size.RIGHT_OFFSET;
	  var endY = Size.FLET_LEN + Size.TOP_OFFSET;
	  var min_pos = getFirstFlet(scale);
	  ...
	  for (var i = 0; i < 24; i++) {
	    ...
	    if (i === 2 || i === 4 || i === 6 || i === 8 || i === 11 || i === 14 || i === 16 || i === 18 || i === 20) {
	      ctx.beginPath();
	...
	function drawStrings(ctx) {
	  var startX = Size.RIGHT_OFFSET;
	  var startY = Size.TOP_OFFSET;
	  var endX = Size.RIGHT_OFFSET + Size.LINE_LEN;
	  var endY = Size.TOP_OFFSET;
	  ctx.lineWidth = 2;
	  ctx.beginPath();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _mode = __webpack_require__(205);

	var _mode2 = _interopRequireDefault(_mode);

	var _key = __webpack_require__(206);

	var _key2 = _interopRequireDefault(_key);

	var _size = __webpack_require__(207);
...
/***/ (function(module, exports) {
	...
	exports.default = {
	  ...
	  'Pentatonic Major': 'R||9||M3|||P5||13||',
	  'Pentatonic Minor': 'R|||m3||11||P5|||m7|',
	  Ionian: 'R||9||M3|11||P5||13||M7',
	  Dorian: 'R||9|m3||11||P5||13|m7|',
	  Phrygian: 'R|b9||m3||11||P5|b13||m7|',
	  Lydian: 'R||9||M3||#11|P5||13||M7',
	  Mixolydian: 'R||9||M3|11||P5||13|m7|',
	  Aeolian: 'R||9|m3||11||P5|b13||m7|',
	  Locrian: 'R|b9||m3||11||P5|b13||m7|',
	  Chromatic: 'R|b9|9|m3|M3|11|#11|P5|b13|13|m7|M7'
	};
...
/***/ (function(module, exports) {
	...
	offset.FLET_LEN = offset.LINE_OFFSET * 5;
	offset.LINE_LEN = offset.FLET_OFFSET * 23;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var CanvasFront = function (_Component) {
	  _inherits(CanvasFront, _Component);

	  function CanvasFront(props) {
	    _classCallCheck(this, CanvasFront);

	    return _possibleConstructorReturn(this, (CanvasFront.__proto__ || Object.getPrototypeOf(CanvasFront)).call(this, props));
	  }
	  ...
	  _createClass(CanvasFront, [{
	    ...
	    value: function componentDidMount() {
	      var _refs$canvas = this.refs.canvas,
	          width = _refs$canvas.width,
	          height = _refs$canvas.height;
	      var _props = this.props,
	          tonality = _props.tonality,
	          mode = _props.mode;
	    ...
	    value: function componentDidUpdate() {
	      var _refs$canvas2 = this.refs.canvas,
	          width = _refs$canvas2.width,
	          height = _refs$canvas2.height;
	      var _props2 = this.props,
	          tonality = _props2.tonality,
	          mode = _props2.mode;
	    ...
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement('canvas', { className: 'fingerPosition', ref: 'canvas', width: '1024px', height: '256px' });
	    }
	  }]);
	...
	function drawPosition(ctx, scale, mode, key) {
	  ...
	  for (var i = 0; i < 6; i++) {
	    var startX = Size.RIGHT_OFFSET - Size.FLET_OFFSET / 2;
	    ...
	    for (var j = 0; j < pos.length; j++) {
	      ...
	      var textWidth = ctx.measureText(pos_data).width;
	      ctx.font = Style.FILL.FONT;
	...
	function drawPosName(ctx, scale) {
	  var startX = Size.FLET_OFFSET / 2 + Size.RIGHT_OFFSET;
	  var startY = Size.TOP_OFFSET;
	  var pos = scale.split("|");
	  var min_pos = getFirstFlet(scale);
	  ...
	  for (var i = 0; i < 4; i++) {
	    ctx.fillText(min_pos, startX + FLET_OFFSET * i, FLET_OFFSET * 5 + FLET_OFFSET, 128);
	    startY += LINE_OFFSET;
	    min_pos++;
	  }
	  ctx.stroke();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SelectKey = function SelectKey(props) {
	  return _react2.default.createElement(
	    'select',
	    props,
	    Object.keys(_key2.default).map(function (k) {
	      return _react2.default.createElement(
	        'option',
	        { key: k, value: k },
	        k
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SelectMode = function SelectMode(props) {
	  return _react2.default.createElement(
	    'select',
	    props,
	    Object.keys(_mode2.default).map(function (mode) {
	      return _react2.default.createElement(
	        'option',
	        { key: mode, value: mode },
	        mode
